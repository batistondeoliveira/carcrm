            ...
            <div className="row">
                <div className="col-md-4 mb-4">
                    <div className="card">
                        ...
                        <div className="card-body text-center">
                            <h5 className="mb-3">
                                Total de {new Intl.NumberFormat('pt-BR', {style: 'currency', currency: 'BRL'}).format(plan.price)} 
                            </h5>
                        ...
                        {(!pay_type) &&
                            <>
                                ...
                                <div className="d-flex pointer" onClick={() => dispatch(change({ pay_type: 'card' }))}>
                                    ...
                                    <div className="ml-4 d-flex flex-column align-itens-center">
                                        <label className="h5 mb-1 mr-auto">
                                            Cartão
                                        </label>

                                        <label className="text-muted mr-auto">
                                            Crédito
                                        </label>
                                    </div>
                                </div>                        
                                ...
                                <div className="d-flex pointer" onClick={() => dispatch(change({ pay_type: 'bolbradesco' }))}>
                                    ...
                                    <div className="ml-4 d-flex flex-column align-itens-center">
                                        ...
                                        <label className="text-muted mr-auto">
                                            O pagamento será aprovado de 1 a 3 dias úteis
                                        </label>
                                    </div>
                                </div>
                            </>
